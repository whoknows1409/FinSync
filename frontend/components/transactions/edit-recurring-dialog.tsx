...
interface EditRecurringTransactionDialogProps {
  ...
  onSave: (id: string, transaction: Partial<RecurringTransaction>) => Promise<void>
...
export function EditRecurringTransactionDialog({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await onSave(recurringTransaction._id, {
        type: formData.type,
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-2 pt-4">
            ...
            <Button type="submit" disabled={loading}>
              {loading ? 'Saving...' : 'Update Recurring Transaction'}
            </Button>
          </div>
        </form>
      </DialogContent>
